...
public class Bank2 extends JFrame implements ActionListener, ItemListener, ChangeListener {
    ...
    public Bank2() {
        ...
        listModel.addElement("Tabungan Umum");
